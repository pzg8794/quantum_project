...
class QuantumEvaluatorVisualizer:
    ...
    def __init__(self, comparison_results={}, framework_config=None, config=None, base_output_dir="./quantum_experiments_results"):
        """
        ...
        """
        self.config = config if config is not None else QuantumExperimentConfig()
