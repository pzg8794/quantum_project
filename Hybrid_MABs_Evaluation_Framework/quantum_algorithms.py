...
from quantum_base_algorithms import QuantumModel, NeuralUCB, Oracle, LinUCB, UCB, RandomAlg, TS, LinTS
...
class EXPNeuralUCB(QuantumModel):
    ...
    def run(self, attack_list, verbose=True):
...
class CPursuitNeuralUCB(EXPNeuralUCB):
    ...
    def __init__(self, X_n, reward_list, frame_number, mode='cmab', 
                 gamma_factor=0.1, eta_factor=0.005, beta=0.2, learning_rate=0.1):
...
class iCPursuitNeuralUCB(CPursuitNeuralUCB):
    ...
    def __init__(self, X_n, reward_list, frame_number, mode='icmab',
        ...
        super().__init__(X_n, reward_list, frame_number, 'cmab',
                        gamma_factor, eta_factor, beta, learning_rate)
